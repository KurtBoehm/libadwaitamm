...
int main(int, char**)
{
  ...
  std::cout << get_defs(ADW_TYPE_ALERT_DIALOG);
  ...
  std::cout << get_defs(ADW_TYPE_BANNER);
  std::cout << get_defs(ADW_TYPE_BIN);
  std::cout << get_defs(ADW_TYPE_BOTTOM_SHEET);
  std::cout << get_defs(ADW_TYPE_BREAKPOINT);
  std::cout << get_defs(ADW_TYPE_BREAKPOINT_BIN);
  std::cout << get_defs(ADW_TYPE_BUTTON_CONTENT);
  std::cout << get_defs(ADW_TYPE_BUTTON_ROW);
