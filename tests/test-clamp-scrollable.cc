...
static void test_adw_clamp_scrollable_child() {
...
static void test_adw_clamp_scrollable_maximum_size() {
  Adw::ClampScrollable clamp;
...
static void test_adw_clamp_scrollable_tightening_threshold() {
  Adw::ClampScrollable clamp;
...
static void test_adw_clamp_scrollable_unit() {
  Adw::ClampScrollable clamp;
...
int main(int argc, char* argv[]) {
  ...
  g_test_add_func("/Adwaita/ClampScrollable/child", test_adw_clamp_scrollable_child);
  g_test_add_func("/Adwaita/ClampScrollable/maximum_size", test_adw_clamp_scrollable_maximum_size);
  g_test_add_func("/Adwaita/ClampScrollable/tightening_threshold",
                  test_adw_clamp_scrollable_tightening_threshold);
  g_test_add_func("/Adwaita/ClampScrollable/unit", test_adw_clamp_scrollable_unit);
  return g_test_run();
}
