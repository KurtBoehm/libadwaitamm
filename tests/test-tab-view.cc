...
template<size_t N>
static void add_pages(Adw::TabView& view, std::array<Glib::RefPtr<Adw::TabPage>, N>& pages, int n,
                      int n_pinned) {
...
template<size_t N>
static void assert_page_positions(Adw::TabView& view,
...
static void test_adw_tab_view_n_pages() {
  Adw::TabView view;
...
static void test_adw_tab_view_n_pinned_pages() {
  Adw::TabView view;

  notified = 0;
  view.property_n_pinned_pages().signal_changed().connect(sigc::ptr_fun(notify_cb));
...
static void test_adw_tab_view_default_icon() {
  Adw::TabView view;
  ...
  notified = 0;
  view.property_default_icon().signal_changed().connect(sigc::ptr_fun(notify_cb));
...
static void test_adw_tab_view_menu_model() {
  Adw::TabView view;
...
static void test_adw_tab_view_shortcuts() {
  Adw::TabView view;

  notified = 0;
  view.property_shortcuts().signal_changed().connect(sigc::ptr_fun(notify_cb));

  Adw::TabView::Shortcuts shortcuts = view.get_property<Adw::TabView::Shortcuts>("shortcuts");
  g_assert_true(shortcuts == Adw::TabView::Shortcuts::ALL_SHORTCUTS);
  g_assert_true(notified == 0);

  view.set_shortcuts(Adw::TabView::Shortcuts::CONTROL_PAGE_UP);
  g_assert_true(view.get_shortcuts() == Adw::TabView::Shortcuts::CONTROL_PAGE_UP);
  g_assert_true(notified == 1);

  view.set_property<Adw::TabView::Shortcuts>("shortcuts",
                                             Adw::TabView::Shortcuts::CONTROL_PAGE_DOWN);
  g_assert_true(view.get_shortcuts() == Adw::TabView::Shortcuts::CONTROL_PAGE_DOWN);
  g_assert_true(notified == 2);
...
static void test_adw_tab_view_get_page() {
  Adw::TabView view;
...
static void test_adw_tab_view_select() {
  Adw::TabView view;

  notified = 0;
  view.property_selected_page().signal_changed().connect(sigc::ptr_fun(notify_cb));
  ...
  Glib::RefPtr<Adw::TabPage> page1 = view.append(*Gtk::make_managed<Gtk::Button>());
  g_assert_true(view.get_selected_page() == page1);
  g_assert_true(page1->get_selected());
  g_assert_true(notified == 1);

  Glib::RefPtr<Adw::TabPage> page2 = view.append(*Gtk::make_managed<Gtk::Button>());
  g_assert_true(view.get_selected_page() == page1);
  g_assert_true(page1->get_selected());
...
static void test_adw_tab_view_add_basic() {
  Adw::TabView view;
...
static void test_adw_tab_view_add_auto() {
  Adw::TabView view;
...
static void test_adw_tab_view_reorder() {
  Adw::TabView view;
  std::array<Glib::RefPtr<Adw::TabPage>, 6> pages;
...
static void test_adw_tab_view_reorder_first_last() {
  Adw::TabView view;
  std::array<Glib::RefPtr<Adw::TabPage>, 6> pages;
...
static void test_adw_tab_view_reorder_forward_backward() {
  Adw::TabView view;
  std::array<Glib::RefPtr<Adw::TabPage>, 6> pages;
...
static void test_adw_tab_view_pin() {
  Adw::TabView view;
...
static void test_adw_tab_view_close() {
  Adw::TabView view;
...
static void test_adw_tab_view_close_other() {
  Adw::TabView view;
  std::array<Glib::RefPtr<Adw::TabPage>, 6> pages;
...
static void test_adw_tab_view_close_before_after() {
  Adw::TabView view;
...
static bool close_page_position_cb(const Glib::RefPtr<Adw::TabPage>& page, Adw::TabView& view) {
...
static void test_adw_tab_view_close_signal() {
  Adw::TabView view;
  std::array<Glib::RefPtr<Adw::TabPage>, 10> pages;
...
static void test_adw_tab_view_close_select() {
  Adw::TabView view;
  ...
  assert_page_positions(view, pages, 14, 3, {0, 1, 2, 12, 13, 3, 4, 9, 11, 10, 5, 6, 7, 8});
  ...
  /* No parent */
  assert_page_positions(view, pages, 13, 3, {0, 1, 2, 12, 13, 3, 4, 9, 11, 10, 5, 6, 7});
  ...
  assert_page_positions(view, pages, 11, 3, {0, 1, 2, 12, 13, 3, 4, 9, 11, 10, 5});
...
static void test_adw_tab_view_transfer() {
  Adw::TabView view1;
  Adw::TabView view2;
...
static void test_adw_tab_view_pages() {
  Adw::TabView view;
  ...
  Glib::RefPtr<Gio::ListModel> list_model = std::dynamic_pointer_cast<Gio::ListModel>(pages_model);
...
static void test_adw_tab_page_title() {
  Adw::TabView view;
...
static void test_adw_tab_page_tooltip() {
  Adw::TabView view;
...
static void test_adw_tab_page_icon() {
  ...
  Glib::RefPtr<Gio::Icon> icon = page->get_property<Glib::RefPtr<Gio::Icon>>("icon");
...
static void test_adw_tab_page_loading() {
  Adw::TabView view;
...
static void test_adw_tab_page_indicator_icon() {
  Adw::TabView view;
  Glib::RefPtr<Gio::Icon> icon1 = Gio::ThemedIcon::create("go-previous-symbolic");
  Glib::RefPtr<Gio::Icon> icon2 = Gio::ThemedIcon::create("go-next-symbolic");
  ...
  notified = 0;
  page->property_indicator_icon().signal_changed().connect(sigc::ptr_fun(notify_cb));

  Glib::RefPtr<Gio::Icon> icon = page->get_property<Glib::RefPtr<Gio::Icon>>("indicator-icon");
  g_assert_true(icon == nullptr);
  g_assert_true(notified == 0);
...
static void test_adw_tab_page_indicator_tooltip() {
  Adw::TabView view;

  Glib::RefPtr<Adw::TabPage> page = view.append(*Gtk::make_managed<Gtk::Button>());

  notified = 0;
  page->property_indicator_tooltip().signal_changed().connect(sigc::ptr_fun(notify_cb));

  Glib::ustring tooltip = page->get_property<Glib::ustring>("indicator-tooltip");
  g_assert_true(tooltip == "");
  g_assert_true(notified == 0);
...
static void test_adw_tab_page_indicator_activatable() {
  Adw::TabView view;

  Glib::RefPtr<Adw::TabPage> page = view.append(*Gtk::make_managed<Gtk::Button>());

  notified = 0;
  page->property_indicator_activatable().signal_changed().connect(sigc::ptr_fun(notify_cb));

  bool indicator_activatable = page->get_property<bool>("indicator-activatable");
...
static void test_adw_tab_page_needs_attention() {
  Adw::TabView view;

  Glib::RefPtr<Adw::TabPage> page = view.append(*Gtk::make_managed<Gtk::Button>());

  notified = 0;
  page->property_needs_attention().signal_changed().connect(sigc::ptr_fun(notify_cb));
...
static void
test_adw_tab_view_pages_to_list_view_bind(const Glib::RefPtr<Gtk::ListItem>& list_item) {
  Glib::RefPtr<Gtk::Label> item = std::dynamic_pointer_cast<Gtk::Label>(list_item->get_item());
  ...
  Glib::RefPtr<Glib::Binding> binding = Glib::Binding::bind_property(
    item->property_label(), row->property_label(), Glib::Binding::Flags::SYNC_CREATE);
...
static void
test_adw_tab_view_pages_to_list_view_unbind(const Glib::RefPtr<Gtk::ListItem>& list_item) {
  Glib::Binding* binding = reinterpret_cast<Glib::Binding*>(list_item->get_data("BINDING"));

  binding->unbind();
  binding->unreference();
}

static void test_adw_tab_view_pages_to_list_view() {
  Adw::TabView view;
  ...
  factory->signal_setup().connect(sigc::ptr_fun(test_adw_tab_view_pages_to_list_view_setup));
  factory->signal_bind().connect(sigc::ptr_fun(test_adw_tab_view_pages_to_list_view_bind));
  factory->signal_unbind().connect(sigc::ptr_fun(test_adw_tab_view_pages_to_list_view_unbind));
