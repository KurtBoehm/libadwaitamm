...
FlapDemoWindow* FlapDemoWindow::create() {
  GObject* obj = g_object_new_with_properties(FlapDemoWindow::get_type(), 0, nullptr, nullptr);
  return FlapDemoWindow::wrap(obj);
}

void FlapDemoWindow::setup_template(Gtk::TemplateWidgetSetup& s) {
  s.set_resource("/org/gnome/Adwaitamm1/Demo/ui/pages/flap/adw-flap-demo-window.ui");
  ...
  s.bind_callback("start_toggle_button_toggled_cb",
                  Gtk::ptr_fun_to_mem_fun<&FlapDemoWindow::start_toggle_button_toggled_cb>());

  s.bind_callback("stack_notify_visible_child_cb",
                  Gtk::ptr_fun_to_mem_fun<&FlapDemoWindow::stack_notify_visible_child_cb>());
