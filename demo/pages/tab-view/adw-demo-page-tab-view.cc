...
void DemoPageTabView::setup_template(Gtk::TemplateWidgetSetup& s) {
  s.set_resource("/org/gnome/Adwaitamm1/Demo/ui/pages/tab-view/adw-demo-page-tab-view.ui");

  s.install_action("demo.run", Gtk::ptr_fun_to_mem_fun<&DemoPageTabView::demo_run_cb>());
}
