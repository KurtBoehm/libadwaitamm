...
namespace Adw {
class TabViewDemoWindow : public Gtk::TemplateWidget<TabViewDemoWindow, Adw::Window> {
  friend CppClassType;
...
private:
  ...
  Glib::RefPtr<Adw::TabPage> add_page(const Glib::RefPtr<Adw::TabPage>& parent,
                                      const Glib::ustring& title, Glib::RefPtr<Gio::Icon> icon);
  ...
  void tab_change_indicator(const Glib::RefPtr<Gio::SimpleAction>& action, bool indicator);
  void tab_change_icon(const Glib::RefPtr<Gio::SimpleAction>& action, bool enable_icon);
  ...
  static Glib::RefPtr<Gio::Icon> get_indicator_icon(const Glib::RefPtr<Adw::TabPage>& page);
  static Glib::ustring get_indicator_tooltip(const Glib::RefPtr<Adw::TabPage>& page);
