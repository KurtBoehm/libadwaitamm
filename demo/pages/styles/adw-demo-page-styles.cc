...
void DemoPageStyles::setup_template(Gtk::TemplateWidgetSetup& s) {
  s.set_resource("/org/gnome/Adwaitamm1/Demo/ui/pages/styles/adw-demo-page-styles.ui");
  s.install_action("demo.run", Gtk::ptr_fun_to_mem_fun<&DemoPageStyles::demo_run_cb>());
}
