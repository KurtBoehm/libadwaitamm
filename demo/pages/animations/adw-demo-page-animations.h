...
namespace Adw {
class DemoPageAnimations : public Gtk::TemplateWidget<DemoPageAnimations, Adw::Bin> {
  friend CppClassType;
...
private:
  ...
  std::unique_ptr<Glib::Property<Glib::RefPtr<Adw::Animation>>> p_timed_animation;
  std::unique_ptr<Glib::Property<Glib::RefPtr<Adw::Animation>>> p_spring_animation;
  ...
  static char* animations_easing_name(AdwEnumListItem* value, gpointer user_data);
  static void timed_animation_measure(GtkWidget* widget, GtkOrientation orientation, int for_size,
                                      int* minimum, int* natural, int* minimum_baseline,
                                      int* natural_baseline);
  static void timed_animation_allocate(GtkWidget* widget_, int width, int height, int baseline);
  static char* get_play_pause_icon_name(gpointer user_data, AdwAnimationState timed_state,
                                        AdwAnimationState spring_state);
  static gboolean timed_animation_can_reset(gpointer user_data, AdwAnimationState timed_state,
                                            AdwAnimationState spring_state);
  static gboolean timed_animation_can_skip(gpointer user_data, AdwAnimationState timed_state,
                                           AdwAnimationState spring_state);
