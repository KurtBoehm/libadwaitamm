...
void DemoPageLists::setup_template(Gtk::TemplateWidgetSetup& s) {
  ...
  s.set_resource("/org/gnome/Adwaitamm1/Demo/ui/pages/lists/adw-demo-page-lists.ui");

  s.bind_callback("entry_apply_cb", Gtk::ptr_fun_to_mem_fun<&DemoPageLists::entry_apply_cb>());
}
