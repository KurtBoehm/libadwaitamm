...
void DemoPreferencesWindow::init_widget(Gtk::TemplateWidgetInit& i) {
  ...
  simple_action_group->add_action("show", sigc::mem_fun(*this, &DemoPreferencesWindow::toast_show));
...
void DemoPreferencesWindow::return_to_preferences() {
  close_subpage();
}
